#!/usr/bin/env python3
"""v9: v7 two-size cocoa opening composited with cream×cavity snap, not RGB lerp."""
...
def main() -> None:
    ...
    mid_mask.save(AUDIT / "v9-mid-cavity-mask.png", optimize=True)
    roar_mask.save(AUDIT / "v9-roar-cavity-mask.png", optimize=True)
    side_mask.save(AUDIT / "v9-smile-wing-erase-mask.png", optimize=True)
    smile_image.save(AUDIT / "v9-accepted-smile.png", optimize=True)
    ...
    manifest: dict[str, object] = {
        ...
        "generation_route": (
            "deterministic v9: v7 smile-rim two-size cocoa opening plus "
            "cream×cavity snap in mix_rendered_mask_images / blendRenderedMaskSample; "
            "no new ImageGen"
        ),
        "runtime_export": {
            "side_px": 1254,
