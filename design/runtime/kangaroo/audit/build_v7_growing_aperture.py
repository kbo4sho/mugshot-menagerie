#!/usr/bin/env python3
"""v7: grow one cavity down from the smile rim so late blends cannot keep a closed W."""
...
MID_DEPTH, MID_EDGE = 24.0, 8.0
ROAR_DEPTH, ROAR_EDGE = 56.0, 14.0
CREAM_SHIFT = 22
...
def main() -> None:
    ...
    smile_image.save(AUDIT / "v7-accepted-smile.png", optimize=True)
    ...
    manifest: dict[str, object] = {
        ...
        "generation_route": (
            "deterministic v7 growing-aperture repair: roar-mid and roar share the "
            "neutral smile's upper rim and grow one cocoa cavity downward; leftover "
            "W wings outside that span are filled with sampled muzzle cream; no new ImageGen"
        ),
        "runtime_export": {
            "side_px": 1254,
            "quality": 95,
